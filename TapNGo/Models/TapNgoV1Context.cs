...
public partial class TapNgoV1Context : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__MenuCate__3214EC07B9F91883");
        });

        modelBuilder.Entity<MenuItem>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__MenuItem__3214EC07F4AD2DAD");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Order__3214EC07085B3936");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__OrderIte__3214EC07F072541F");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Review__3214EC07FB6C79EC");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Role__3214EC073108829F");
        });

        modelBuilder.Entity<User>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__User__3214EC07EAF9E6F7");
